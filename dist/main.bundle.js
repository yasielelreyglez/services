...
var ApiService = (function () {
    ...
    ApiService.prototype.topSubcategories = function () {
        return this.http.get('/login/api/topsubcategories').map(function (response) {
            if (response)
                return response.json().data;
            else {
                return new __WEBPACK_IMPORTED_MODULE_3__models_subcategory__["a" /* Subcategory */][0];
            }
        });
    };
    ApiService.prototype.categories = function () {
        return this.http.get('/login/api/categories').map(function (response) {
            if (response)
                return response.json().data;
            else {
                return new Array();
    ...
    ApiService.prototype.subCategories = function (id) {
        return this.http.get('/login/api/subcategories/' + id).map(function (response) {
            if (response)
                return response.json().data;
            else {
                return new Array();
    ...
    ApiService.prototype.servicesSub = function (id) {
        return this.http.get('/login/api/servicessub/' + id).map(function (response) {
            if (response)
                return response.json().data;
            else {
                return new Array();
    ...
    ApiService.prototype.myfavorites = function () {
        return this.http.get('/login/api/myfavorites').map(function (response) {
            if (response)
                return response.json().data;
            else {
                return new Array();
    ...
    ApiService.prototype.myServices = function () {
        return this.http.get('/login/api/myservices').map(function (response) {
            if (response)
                return response.json().data;
            else {
                return new Array();
    ...
    ApiService.prototype.service = function (id) {
        ...
        if (currentUser) {
            ...
            return this.http.get('/login/api/service/' + id, { headers: headers }).map(function (response) {
                if (response)
                    return response.json().data;
                else {
                    return new Array();
            ...
            return this.http.get('/login/api/service/' + id).map(function (response) {
                if (response)
                    return response.json().data;
                else {
                    return new Array();
    ...
    ApiService.prototype.report = function (report) {
        return this.http.post('/login/api/report', report).map(function (response) {
...
var AuthService = (function () {
    ...
    AuthService.prototype.login = function (user) {
        ...
        return this.http.post('/login/auth/login', body).map(function (response) { return response.json(); }).map(function (result) {
            if (!result.error) {
    ...
    AuthService.prototype.forgotPassword = function (email) {
        return this.http.post('/login/api/forgotpassword', email).map(function (response) {
            if (response.json().result === true) {
                return true;
            }
            else {
