...
var AuthService = (function () {
    ...
    AuthService.prototype.login = function (user) {
        var body = JSON.stringify({ email: user.username, password: user.password });
    ...
    AuthService.prototype.error = function (error) {
        ...
        console.log(msg);
        __WEBPACK_IMPORTED_MODULE_2_rxjs__["a" /* Observable */].throw(msg);
    };
    AuthService.prototype.getUrl = function (url) {
...
var UserService = (function () {
    function UserService(http, jsonp, authService) {
        ...
        this.apiUrl = 'http://localhost/login/';
    }
    ...
    UserService.prototype.getTest = function () {
        ...
        var value = this.http.get(this.getUrl('api/peticion'), { headers: headers })
            .map(function (response) { return response.json(); });
        return value;
    };
    UserService.prototype.getUrl = function (url) {
        return this.apiUrl + url;
    };
    return UserService;
}());
...
var routes = [
    ...
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__components_home_home_component__["a" /* HomeComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_0__guards_auth_guard__["a" /* AuthGuard */]] },
    // otherwise redirect to home
    { path: '**', redirectTo: '' }
];
var AppRoutes = __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* RouterModule */].forRoot(routes);
...
module.exports = "<h1>Todo esta fresa</h1>\n<p>\n  <a [routerLink]=\"['/login']\">Logout</a>\n  <a (click)=\"clickTest()\" >testing api</a>\n\n</p>\n\n<p>{{result_test}}</p>"
...
var HomeComponent = (function () {
    function HomeComponent(user) {
        this.user = user;
        this.result_test = "primerdato";
    }
    HomeComponent.prototype.ngOnInit = function () {
    };
    HomeComponent.prototype.clickTest = function () {
        var _this = this;
        var test = this.user.getTest().subscribe(function (dato) {
            console.log(dato);
            _this.result_test = dato.username;
            return dato;
        });
        console.log(test);
    };
