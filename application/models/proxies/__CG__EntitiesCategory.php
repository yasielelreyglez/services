...
class Category extends \Entities\Category implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['title' => NULL, 'icon' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'title', 'icon', '' . "\0" . 'Entities\\Category' . "\0" . 'subcategories', 'subcategoriesLists'];
        }

        return ['__isInitialized__', 'id', '' . "\0" . 'Entities\\Category' . "\0" . 'subcategories', 'subcategoriesLists'];
    }
