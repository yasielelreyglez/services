$(document).ready(function ($) {
    ...
    $('.listing-views a').on('click', function (ev) {
        ev.preventDefault();
    ...
    $('.popular_listings button').on('click', function () {
        window.location.href = 'home/servicesbyfilter/' + $('select[name="order"]').val();
    })

    $('.step-views .f1-step a').on('click', function (ev) {
        ev.preventDefault();
...
function initMap() {
    ...
    $('#addPosition').on('click', function (t) {
...
var lastPosition = null, gmarkers = [];
